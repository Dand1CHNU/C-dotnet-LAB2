...

{
    internal class Main_class
    {
        public static void Main(string[] args)
        {
            ...
            Exam[] newExams = new Exam[] { new Exam("HTML", 3, new DateOnly(2020, 12, 25)), new Exam("Graphic", 2, new DateOnly(2019, 6, 6)) };
            Test[] newTests = new Test[] { new Test("HTML", true), new Test("C", false) };
